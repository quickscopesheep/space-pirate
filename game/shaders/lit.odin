...
/*
    ...
    Cmdline:
        sokol-shdc --input game/shaders/lit.glsl --output game/shaders/lit.odin --slang hlsl5:wgsl --format sokol_odin

    Overview:
    =========
    Shader program: 'lit':
        Get shader desc: lit_shader_desc(sg.query_backend())
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_lit_lit_a_pos => 0
            ATTR_lit_lit_a_uv => 1
    Bindings:
...
lit_shader_desc :: proc (backend: sg.Backend) -> sg.Shader_Desc {
    desc: sg.Shader_Desc
